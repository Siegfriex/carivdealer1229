    ...
    <div className="min-h-screen bg-[var(--color-background,#f8f9fa)]">
      ...
      <div className={`flex ${LAYOUT_CLASSES.CONTAINER}`}>
        ...
        <main className={`flex-1 p-6 ${LAYOUT_CLASSES.MAIN_DETAIL}`}>
            ...
            <>
              ...
              <div className="flex flex-wrap justify-center gap-8 max-w-[620px] mx-auto">
                <button
                  ...
                  className="bg-white rounded-[15px] w-[297px] min-h-[280px] p-6 flex flex-col items-center text-left hover:opacity-95 transition-opacity focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)] focus:ring-offset-2"
                ...
                >
                  ...
                  <h2 className="text-[26px] font-bold text-[var(--color-primary)] mb-3" style={{ fontFamily: 'var(--font-primary)' }} data-node-id="794:3712">
                    일반 판매
                  </h2>
                  <p className="text-[15px] text-black leading-6" style={{ fontFamily: 'var(--font-primary)' }} data-node-id="794:3713">
                ...
                >
                  ...
                  <h2 className="text-[26px] font-bold text-[var(--color-primary)] mb-3" style={{ fontFamily: 'var(--font-primary)' }} data-node-id="794:3724">
                    경매
                  </h2>
                  <p className="text-[15px] text-black leading-6" style={{ fontFamily: 'var(--font-primary)' }} data-node-id="794:3725">
          ...
          {step === 'analyzing' && (
            <>
              {/* 794-4015: 시세분석중 — 기준 가격 설정 / 홍길동님의 차량 시세를 분석 중입니다 ... */}
              <div className="flex flex-col items-center justify-center min-h-[320px] text-center">
                <div className="relative mb-8">
                  <Loader2 className="h-[75px] w-[75px] text-[var(--color-primary)] animate-spin" aria-hidden />
                </div>
                <h2 className="text-[32px] font-bold text-[var(--color-primary)] mb-3" style={{ fontFamily: 'var(--font-primary)' }} data-node-id="794:4101">
                  기준 가격 설정
                </h2>
                <p className="text-[20px] text-gray-900 max-w-[380px]" style={{ fontFamily: 'var(--font-primary)' }} data-node-id="794:4102">
