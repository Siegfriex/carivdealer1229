/**
 * TradeDetailPage (Figma 1418:24679 거래상세_변형, 1418:24463 — §3.5 차량 등록·상세·경매)
 * 거래 상세 보기 — 일반 판매. 좌측 진행상황, 차량정보·전체 피드백, 판매 방식 4카드, 구매 제안.
...
import { RefreshCw, Wallet, Archive, Trash2, Building } from 'lucide-react';
