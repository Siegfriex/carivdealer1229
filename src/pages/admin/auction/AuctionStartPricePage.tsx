      ...
      <div className={LAYOUT_CLASSES.CONTAINER}>
        <div className="flex">
          ...
          <main className={`flex-1 p-6 ${LAYOUT_CLASSES.MAIN_DETAIL}`}>
            ...
            {/* 1123-13580: 좌측 차량정보 패널 320×420 (1123:13582) */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8" data-node-id="1123:13580">
              <div className={`bg-white shrink-0 ${LAYOUT_CLASSES.DETAIL_PANEL}`} data-node-id="1123:13582">
