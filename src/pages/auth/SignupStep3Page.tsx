/**
 * SignupStep3Page Component
 * 회원가입 Step 3 - 딜러 정보 입력
 * 
 * 디자인: design/design_SignIn/A. 회원/회원가입_3.svg
 */
...
const steps: ProgressStep[] = [
  ...
  { id: 'step3', label: '딜러 정보 입력', status: 'current' },
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1" style={{ marginLeft: 'var(--sidebar-width-vw)' }}>
        <div className="max-w-2xl mx-auto px-6 py-16">
          <h1 className="text-h1 font-bold text-gray-900 mb-2">딜러 정보를 입력해주세요</h1>
          <p className="text-body text-gray-600 mb-12">기본 정보를 입력해주세요</p>

          <div className="space-y-6">
            <Input
              label="딜러명"
              type="text"
              placeholder="예: Global Motors"
              value={dealerName}
