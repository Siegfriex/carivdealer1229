...
export interface MockLogisticsItem {
  ...
  modelYear: string;
  mileage: string;
  state: 'schedule' | 'assigned' | 'pickup_done' | 'handover_done';
  thumbnailUrl?: string;
  vehicleId?: string;
}
...
export const MOCK_LOGISTICS_ITEMS: MockLogisticsItem[] = [
  { id: 'log-1', plateNumber: '12나 7890', modelName: 'G70 3T 스포츠 엘리트', modelYear: '2020', mileage: '5.5', state: 'schedule', vehicleId: 'v-t5' },
  { id: 'log-2', plateNumber: '98다 1111', modelName: 'K5', modelYear: '2021', mileage: '4.0', state: 'assigned', vehicleId: 'v-t6' },
  { id: 'log-3', plateNumber: '11하 2222', modelName: '투싼', modelYear: '2020', mileage: '6.2', state: 'pickup_done', vehicleId: 'v-t7' },
  { id: 'log-4', plateNumber: '33바 3333', modelName: '카니발 KA4', modelYear: '2023', mileage: '2.1', state: 'handover_done', vehicleId: 'v-t4' },
  { id: 'log-5', plateNumber: '12가 3456', modelName: '아반떼', modelYear: '2022', mileage: '3.2', state: 'schedule', vehicleId: 'v-t3' },
  { id: 'log-6', plateNumber: '55라 5555', modelName: '그랜저 IG', modelYear: '2019', mileage: '8.2', state: 'assigned', vehicleId: 'v-t2' },
];
...
export const MOCK_LOGISTICS_HISTORY: MockLogisticsRecord[] = [
  { id: 'log-h1', vehicleId: 'v-106', plateNumber: '33바 3333', scheduleDate: '2025-05-25', scheduleTime: '14:00', address: '서울특별시 강남구 테헤란로 123', driverName: '김택시', driverPhone: '010-1234-5678', status: 'in_transit' },
  { id: 'log-h2', vehicleId: 'v-107', plateNumber: '77사 7777', scheduleDate: '2025-05-24', scheduleTime: '10:00', address: '서울특별시 서초구 서초대로 456', driverName: '박운송', driverPhone: '010-9876-5432', status: 'completed' },
  { id: 'log-h3', vehicleId: 'v-108', plateNumber: '12가 3456', scheduleDate: '2025-05-23', scheduleTime: '09:00', address: '인천광역시 서구 봉수대로 158', driverName: '이배송', driverPhone: '010-5555-5555', status: 'completed' },
  { id: 'log-h4', vehicleId: 'v-109', plateNumber: '55라 5555', scheduleDate: '2025-05-22', scheduleTime: '15:00', address: '경기도 성남시 분당구 판교역로 235', status: 'dispatched' },
  { id: 'log-h5', vehicleId: 'v-110', plateNumber: '82가 1923', scheduleDate: '2025-05-21', scheduleTime: '11:00', address: '대전광역시 유성구 과학로 125', status: 'scheduled' },
  { id: 'log-h6', vehicleId: 'v-111', plateNumber: '11하 2222', scheduleDate: '2025-05-20', scheduleTime: '16:00', address: '부산광역시 해운대구 우동 1234', driverName: '최기사', driverPhone: '010-7777-7777', status: 'completed' },
];

/** 케이스 3: 차량 목록 — 6건 (MOCK_VEHICLE_LIST alias, 동일 데이터) */
