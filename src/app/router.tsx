...
import { TradeListPage } from '@/pages/admin/trade/TradeListPage';
import { GeneralSaleOffersPage } from '@/pages/admin/sale/GeneralSaleOffersPage';
import { LogisticsSchedulePage } from '@/pages/admin/logistics/LogisticsSchedulePage';
import { LogisticsHistoryPage } from '@/pages/admin/logistics/LogisticsHistoryPage';
import { SalesHistoryPage } from '@/pages/admin/sale/SalesHistoryPage';
import { SettlementListPage } from '@/pages/admin/settlement/SettlementListPage';
import { SettlementDetailPage } from '@/pages/admin/settlement/SettlementDetailPage';
...
import { TradeDetailPage } from '@/pages/admin/trade/TradeDetailPage';
