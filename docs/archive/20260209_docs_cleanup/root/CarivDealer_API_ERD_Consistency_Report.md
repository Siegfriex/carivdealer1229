...
- [API_ERD_정합성_체크_20260209.md](API_ERD_정합성_체크_20260209.md) — API 명세·매핑 문서·DBML(erd/CarivDealer.dbml) 3자 교차 정합성 체크(엔드포인트/필드/enum/타입 검증).
...
| 1.1 | 2026-02-09 | 정합성 체크 보고서(20260209) 링크 추가. |
